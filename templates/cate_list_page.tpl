...
<body>
                ...
                <tr>
                    ...
                    <td>
                        <select onchange="javascript:location.href=this.value;">
                                ...
                                <option value="../cate_list.php?act=<{$v['id']}>"><{$v['cate_name']}></option>
                                <{/foreach}>
                        </select>
                    </td>
                    <th width="70">关键字:</th>
    ...
    <form action="#" method="post">
        ...
        <div class="result_wrap">
            ...
            <a class="prev" href="../cate_list.php?pageNow=<{$pageNow-1}>" onclick="_prev()">上一页</a>
                <{for $i=1;$i<=$pageCount;$i++}>
                <a href="../cate_list.php?pageNow=<{$i}>"><{$i}></a>
                <{/for}>
            <a class="next" onclick="_next()">下一页</a>
            <a class="end" href="../cate_list.php?pageNow=<{$pageCount}>">最后一页</a>
    ...
    <script>
        ...
        function _next() {
            if(<{$pageNow}> == <{$pageCount}>)
            {
                ...
                $('.next').attr('href','../cate_list.php?pageNow=<{$pageNow+1}>');
        }
